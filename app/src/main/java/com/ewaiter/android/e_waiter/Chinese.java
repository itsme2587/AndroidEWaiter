...
public class Chinese extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {

    private static final int CHINESE_LOADER = 3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getLoaderManager().initLoader(CHINESE_LOADER,null,this);
    ...
    private Cursor getItems() {
        ...
        String[] selectionArgs = new String[] {"Chinese"};
