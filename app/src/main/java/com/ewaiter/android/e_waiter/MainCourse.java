...
public class MainCourse extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {

    private static final int MAINCOURSE_LOADER = 5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getLoaderManager().initLoader(MAINCOURSE_LOADER,null,this);
    ...
    private Cursor getItems() {
        ...
        String[] selectionArgs = new String[] {"Main Course"};
