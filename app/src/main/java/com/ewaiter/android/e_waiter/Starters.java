...
public class Starters extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {

    private static final int STARTERS_LOADER = 8;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getLoaderManager().initLoader(STARTERS_LOADER,null,this);
    ...
    private Cursor getItems() {
        ...
        String[] selectionArgs = new String[] {"Starters"};
